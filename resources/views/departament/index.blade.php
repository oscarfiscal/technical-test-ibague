                                        ...
                                        <tr>
                                            ...
                                            <td scope="row">
                                                <div class="flex">
                                                    ...
                                                    <a href="{{ route('departament.show', $departament->id) }}" class="btn btn-primary mr-2">
                                                    ...
                                                    <form action="{{ route('departament.destroy', $departament->id) }}" method="POST" class="formEliminar">
                                                        @csrf
                                                        @method('DELETE')
